 ...
 * {@code @SpringBootApplication} only scans {@code com.agent.memory}
 ...
 *
 * <p>Both packages are listed to ensure the memory-service's own entities
 * and repositories continue to work alongside the outbox ones.</p>
 */
@Configuration
@EntityScan(basePackages = {"com.agent.memory", "com.agent.common.outbox"})
@EnableJpaRepositories(basePackages = {"com.agent.memory", "com.agent.common.outbox"})
public class MemoryOutboxJpaConfig {
}
