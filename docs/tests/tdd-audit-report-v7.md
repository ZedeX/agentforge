...
| COV-03 F1~F12 决策节点覆盖 | 🟡 部分通过（改善） | 🟡 部分通过（改善） | 保持；v7 未涉及 F2/F3/F6/F7/F9/F8/F10/F11/F12 整改 |
...
| COV-03 F1~F12 决策节点覆盖 | 🟡 部分通过（改善） | 保持；F1（2 子项）+ F4/F5（2 子项）= 4/12 节点组已补；F2/F3/F6/F7/F9 仍缺；F8/F10/F11/F12 阻塞 |
...
| SEQ-02 测试先于实现提交 | ✅ 通过 | ✅ 通过 | 保持 |
| COV-03 F1~F12 决策节点覆盖 | 🟡 部分通过（改善） | 🟡 部分通过（改善） | 保持；F1+F4/F5 已补 4/12 节点组，F2/F3/F6/F7/F9 仍缺，F8/F10/F11/F12 阻塞 |
